...
app.directive('productForm',function ($location) {
  return {
    restrict: 'E',
    scope: {
      product: '=',
...
app.directive('addManualItem',function () {
  return {
    restrict: 'E',
    scope: {
      addItem: '&'
    ...
    link: function (scope, el) {
      scope.inventory = JSON.parse( window.localStorage.getItem( 'inventory' ) );
      scope.add = function () {
...
app.directive('checkout', function (Settings) {
  return {
    restrict: 'E',
    scope: {
      printReceipt: '&',
...
app.directive('receipt',function (Settings) {
  return {
    restrict: 'E',
    scope: {
      transaction: '='
